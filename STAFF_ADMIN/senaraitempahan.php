...
<section id="speakers" class="parallax-section">
	<div class="container">
		<div class="row">
<h1>SENARAI TEMPAHAN PREMIS</h1>
        <nav class="navbar navbar-default query" role="query">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="">
                    <div class="col-sm-12 form-group">
                        <br><br><input type="text" id="namapemohon" onkeyup="myFunction()" placeholder="MASUKKAN NAMA PEMOHON..">
                    </div>
				 ...
				 <?php
                    ...
                    if ($result = $conn->query($sql)){
                      ...
                      while ($row = $result->fetch_object()){
                        ...
                        echo "<td>" . $row->namapemohon. "</td>";
                        echo "<td>" . $row->agensi. "</td>";
						echo "<td>" . $row->tujuan . "</td>";
						echo "<td>" . $row->tarikhmula . "</td>";
                        echo "<td>" . $row->tarikhtamat . "</td>";
						echo "<td width='30px'><a href='print.php?id=" . $row->id . "' class='btn fa fa-print'></span></a></td>";
                        echo "</tr>";
                        }
                        echo "</table>";
                        }
...
function myFunction() {
  ...
  input = document.getElementById("namapemohon");
