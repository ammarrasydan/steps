		...
		<div class="row">
			...
			<div id="owl-speakers" class="owl-carousel">
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<center><img src="images/S1.jpg" class="img-responsive" alt=""></center>
							<div class="speakers-thumb">
								<h5>DILENGKAPI DENGAN BILIK KALIS BUNYI</h5>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
						<img src="images/S4.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>TERSEDIA DENGAN NARRATOR YANG LENGKAP</h5>
							</div>
					</a>
				</div>

				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/S3.jpg" cOlass="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>KEMUDAHAN MERAKAM VIDEO PKG DAN SEKOLAH-SEKOLAH </h5>
							</div>
					</a>
				</div>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/S2.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>KEMUDAHAN BILIK YANG BERHAWA DINGIN</h5>
							</div>
					</a>
				</div>
				</div>
