		...
		<div class="row">
			...
			<div id="owl-speakers" class="owl-carousel">
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<center><img src="images/d1.jpg" class="img-responsive" alt=""></center>
							<div class="speakers-thumb">
								<h5>KEMUDAHAN KERUSI DAN MEJA YANG SELESA</h5>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
						<img src="images/d2.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>DILENGAKAPI DENGAN PAPAN PUTIH UNTUK KEGUNAAN KURSUS</h5>
							</div>
					</a>
				</div>

				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/d3.jpg" cOlass="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>KEADAAN BILIK YANG BERSIH</h5>
							</div>
					</a>
				</div>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/d2.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>DILENGKAPI DENGAN PENGHAWA DINGIN</h5>
							</div>
					</a>
				</div>
				</div>
