		...
		<div class="row">
			...
			<div id="owl-speakers" class="owl-carousel">
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<center><img src="images/CO1.jpg" class="img-responsive" alt=""></center>
							<div class="speakers-thumb">
								<h5>BILANGAN KOMPUTER YANG MENCUKUPI</h5>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
						<img src="images/computer.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>PENGGUNAAN KOMPUTER YANG BERJENAMA "HP"</h5>
							</div>
					</a>
				</div>

				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/computer.jpg" cOlass="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>KEADAAN BILIK YANG BERHAWA DINGIN</h5>
							</div>
					</a>
				</div>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/computer.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>DILENGKAPI DENGAN SISTEM TEAM SUPPORT VIEWER</h5>
							</div>
					</a>
				</div>
				</div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											   ...
											   <td>15 HINGGA 20 ORANG SAHAJA</td>
...
<br>
						<center><input type="submit" alt="Submit" onclick="window.location='daftar_premis.php'" value="TEMPAH SEKARANG!!"></center>
