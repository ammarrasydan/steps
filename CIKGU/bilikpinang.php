		...
		<div class="row">
			...
			<div id="owl-speakers" class="owl-carousel">
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<center><img src="images/c1.jpg" class="img-responsive" alt=""></center>
							<div class="speakers-thumb">
								<h5>KELENGKAPAN KERUSI DAN MEJA MENCUKUPI</h5>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.6s">
						<img src="images/c2.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>KEADAAN BILIK YANG BERSIH DAN SELESA</h5>
							</div>
					</a>
				</div>

				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/bilikpinang.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>RUANG PENTAS YANG LUAS</h5>
							</div>
					</a>
				</div>
				...
				<div class="item wow fadeInUp col-md-3 col-sm-3" data-wow-delay="0.9s">
						<img src="images/c4.jpg" class="img-responsive" alt="">
							<div class="speakers-thumb">
								<h5>DILENGKAPI DENGAN P.A SISTEM</h5>
							</div>
					</a>
				</div>
				</div>
