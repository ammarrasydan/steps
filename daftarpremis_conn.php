...
#echo '<pre>',print_r($_FILES);
	...
	$query = "INSERT INTO tempah_premis (namapremis,tarikh,saluran,namapemohon,agensi,alamat,tujuan,tarikhmula,tarikhtamat,masa,bil,pilih,perlu,status,catatan)
	VALUES('$namapremis','$tarikh', '$saluran', '$namapemohon', '$agensi', '$alamat', '$tujuan', '$tarikhmula', '$tarikhtamat', '$masa', '$bil', '$pilih', '$perlu', '$status', '$catatan')";
#echo $query; exit;
